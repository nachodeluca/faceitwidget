...
export function ObsMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 75 75" fill="none" aria-hidden="true" {...props}>
      <circle cx="37.5" cy="37.5" r="35.8" fill="#302e31" stroke="currentColor" strokeWidth="3.47" />
      <path
