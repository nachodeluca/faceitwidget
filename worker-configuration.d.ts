/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b73b387c2437472fcfe289bea1a899f7)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	PLAYER_REFRESH_INTERVAL_MS: "120000";
	...
	PLAYER_SNAPSHOTS: DurableObjectNamespace<import("./backend/index").PlayerSnapshotCoordinator>;
	SHARED_WIDGETS: DurableObjectNamespace<import("./backend/index").SharedWidgetCard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./backend/index");
		durableNamespaces: "PlayerSnapshotCoordinator" | "SharedWidgetCard";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PLAYER_REFRESH_INTERVAL_MS" | "FACEIT_DATA_API_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_PUBLIC_BASE_URL">> {}
}
