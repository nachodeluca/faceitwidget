/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3ee410124094aa2419ef23e4ffcdf9b2)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "PlayerSnapshotCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LIVE_POLL_INTERVAL_MS">> {}
}
